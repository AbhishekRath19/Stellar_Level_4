  ...
  return (
    <div className="space-y-10">
      <div className="flex items-center justify-between">
        <h3 className="text-2xl font-black italic uppercase tracking-tighter text-white">Market Odds</h3>
            ...
            <div key={idx} className="space-y-4">
              <div className="flex justify-between items-end">
                <div className="space-y-1">
                  ...
                  <div className="text-xl font-mono font-bold text-white">{percentage.toFixed(2)}%</div>
                </div>
                <div className="text-right">
                  <span className="text-[9px] font-black text-gray-700 uppercase block tracking-widest">Stake Pool</span>
                  <span className="text-sm font-mono text-gray-500">{(Number(betAmount) / 10000000).toFixed(2)} MTK</span>
                </div>
              </div>
      ...
      <div className="pt-6 border-t border-white/5 flex justify-center">
        <p className="text-[9px] font-black text-gray-700 uppercase tracking-[0.4em] animate-pulse">
          Sub-second sync with Stellar Network
        </p>
      </div>
    </div>
  );
